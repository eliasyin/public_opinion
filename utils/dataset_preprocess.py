...
if __name__ == "__main__":
    ...
    # )\
    # SemEval15 restaurant
    refactor_dataset(
        os.path.join(path, "atepc_datasets/semeval15/restaurant_train.raw"),
        os.path.join(path, "atepc_datasets/semeval15/Restaurants.atepc.train.dat"),
    )
    refactor_dataset(
        os.path.join(path, "atepc_datasets/semeval15/restaurant_test.raw"),
        os.path.join(path, "atepc_datasets/semeval15/Restaurants.atepc.test.dat"),
    )
    # SemEval16 restaurant
    refactor_dataset(
        os.path.join(path, "atepc_datasets/semeval16/restaurant_train.raw"),
        os.path.join(path, "atepc_datasets/semeval16/Restaurants.atepc.train.dat"),
    )
    refactor_dataset(
        os.path.join(path, "atepc_datasets/semeval16/restaurant_test.raw"),
        os.path.join(path, "atepc_datasets/semeval16/Restaurants.atepc.test.dat"),
    )
